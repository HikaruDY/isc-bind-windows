...
#define isc__nm_async_routeconnect(x,y)
...
#define PACKAGE_CONFIGARGS " '--enable-filter-aaaa' '--enable-backtorace=no' '--enable-threads' '--disable-atomic' '--with-host=no' '--with-ecdsa=no' '--with-libxml2=no' '--with-zlib=no' '--with-gssapi=no' '--without-python' '--disable-doh' '--disable-shared'"

/* An extra string to print after PACKAGE_STRING */
#define PACKAGE_DESCRIPTION " (Development Release)"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BIND"

/* A short hash from git */
#define PACKAGE_SRCID "8e12227"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BIND 9.19.1"
